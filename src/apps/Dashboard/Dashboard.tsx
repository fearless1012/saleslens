              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
                  ...
                  <div
                    ...
                    className="bg-white rounded-lg shadow p-5 cursor-pointer hover:shadow-md transition-all"
                  >
                    <div className="mb-3">
                      <div className="bg-blue-100 inline-block p-3 rounded-lg">
                        <svg
                  ...
                  {[1, 2, 3, 4, 5, 6, 7].map((_, index) => (
                    <div key={index} className="bg-white rounded-lg shadow p-5">
                      <div className="flex items-start space-x-3 mb-3">
                        ...
                        />
                        <div>
                          <h3 className="font-medium">DTC CMO Steve</h3>
                          <p className="text-xs text-gray-500">
